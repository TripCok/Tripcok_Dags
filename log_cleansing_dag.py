...
with DAG(
    ...
    log_cleansing_command = f"""ssh -i ~/.ssh/spark_key.pem ubuntu@{spark_host} /home/ubuntu/spark/bin/spark-submit /home/ubuntu/etl/py/common/LogsCleansing.py --bucket tripcok --folder topics/tripcok --date {{ ds }}"""
